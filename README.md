...
- OpenPose로 관절을 추출해 ControlNet 조건으로 넣고 Stable Diffusion 1.5로 생성합니다. API 키 없이 무료 Colab GPU에서 동작합니다.
...
- [ ] Colab에서 4~7단계를 실행해 `output_01.png` / `output_02.png`를 실제 생성 결과로 교체 (현재는 자리채움 이미지)
- [ ] 노트북 9단계 관찰 기록의 빈칸 채우기
- [ ] 위 테스트 결과의 "생성 결과는 Colab 실행 후 기입" 두 항목 채우기
